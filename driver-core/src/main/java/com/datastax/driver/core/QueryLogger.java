 ...
 *     within a {@link #slowQueryLatencyThresholdMillis configurable threshold in milliseconds}.</li>
 *     <li>{@link #SLOW_LOGGER}: used to log slow queries, i.e., queries that completed successfully
 *     but that took longer than a {@link #slowQueryLatencyThresholdMillis configurable threshold in milliseconds} to complete.</li>
 ...
 *     <li>otherwise, if the reported latency is greater than {@link #slowQueryLatencyThresholdMillis the configured threshold in milliseconds}: use {@link #SLOW_LOGGER};</li>
...
public class QueryLogger implements LatencyTracker {
     ...
     * within at most {@link #DEFAULT_SLOW_QUERY_THRESHOLD_MS} milliseconds.
     ...
     * in more than {@link #DEFAULT_SLOW_QUERY_THRESHOLD_MS} milliseconds.
     * This logger is activated by setting its level to {@code DEBUG} or {@code TRACE}.
     * Additionally, if the level is set to {@code TRACE} and the statement being logged is a {@link BoundStatement},
     * then the query parameters (if any) will be logged as well (names and actual values).
     */
    ...
    public static class Builder {
        ...
        private final QueryLogger instance = new QueryLogger();
